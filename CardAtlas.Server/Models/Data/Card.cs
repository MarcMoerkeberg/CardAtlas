...
public class Card : INameable
{
	...
	[NotMapped]
	public IEnumerable<GameKind> PrintedInGameTypes => _existsInGameTypes ??= GameTypes.Any(gameType => gameType.GameType is not null) ? GameTypes.Select(gameType => gameType.GameType.Type) : [];
